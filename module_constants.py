...
## KARMA SCRIPT SLOTS 	   #############################
########################################################
max_distance_whisper_chat             = 200 # Ashcrow fisildama uzaklik
ambient_distance_whisper_chat         = 100
########################################################
##  PLAYER SLOTS           #############################
########################################################
...
slot_player_in_game 				  = 67
slot_player_admin_ban_reason	 	  = 68
slot_player_admin_ban_target		  = 69
slot_player_is_wounded				  = 70
slot_player_wounded_x				  = 71
slot_player_wounded_y                 = 72
slot_player_wounded_z                 = 73
slot_player_wounded_time 			  = 74
slot_player_wound_class               = 75
slot_player_freezed_horse			  = 76
########################################################
##  AGENT SLOTS            #############################
########################################################
...
slot_scene_prop_inventory_is_accessed = 63
