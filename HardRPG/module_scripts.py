      ...
      (else_try), # chat string received from a client, from a range of event numbers to keep them in order
        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (try_begin),
                (player_is_admin , ":sender_player_id"),
                (player_slot_eq,":sender_player_id",slot_player_admin_ban_reason,1),
                (player_get_slot , ":target_player_id" , ":sender_player_id" , slot_player_admin_ban_target),
                (try_begin),
                    (player_is_admin , ":target_player_id"),
                    (player_set_is_admin , ":target_player_id" , 0),
                (try_end),
                (try_begin),
                    (player_is_active , ":target_player_id"),
                    (kick_player , ":target_player_id"),
                (try_end),
                (player_set_slot , ":sender_player_id" , slot_player_admin_ban_reason , 0),
                (player_get_unique_id , reg5 , ":target_player_id"),
                (str_store_player_username , s9 , ":target_player_id"),
                (str_store_player_username , s10 , ":sender_player_id"),
                
                (str_encode_url , s31),
                (str_encode_url , s9),
                (str_encode_url , s10),
                (str_store_string , s8 , "str_backend_link"),
                (send_message_to_url , "@{s8}/index.php?banplayer={reg5}&banner={s10}&banned={s9}&reason={s31}"),
                (multiplayer_send_string_to_player , ":sender_player_id" , server_event_admin_chat , "@Player is banned."),
            (try_end),
            (try_begin),
              (str_store_trim, s31, s31),
              (str_starts_with, s31, "@/"),
              (str_store_substring, s31, s31, 1),
              (try_begin),
                (str_starts_with, s31, "@me ", 1), # Me komudu
                (player_get_agent_id, ":agent_id", ":sender_player_id"),
                (str_store_substring, s31, s31, 3),
                (gt, ":agent_id", -1),
                (agent_is_alive, ":agent_id"),
                (str_store_player_username, s1, ":sender_player_id"),
                (str_store_string, s0, "str_chat_me_format"),
                (server_add_message_to_log, "str_local_chat_me_log_format"),
                (assign, ":max_sq_distance", sq(max_distance_local_chat)),
                (assign, ":ambient_sq_distance", sq(ambient_distance_local_chat)),
                (assign, ":server_event", server_event_local_chat_shout),
                (set_fixed_point_multiplier, 100),
                ...
                (try_end),
              (else_try),
                (str_starts_with, s31, "@do ", 1), # Do komudu
                (player_get_agent_id, ":agent_id", ":sender_player_id"),
                (str_store_substring, s31, s31, 3),
                (gt, ":agent_id", -1),
                (agent_is_alive, ":agent_id"),
                (str_store_player_username, s1, ":sender_player_id"),
                (str_store_string, s0, "str_chat_do_format"),
                (server_add_message_to_log, "str_local_chat_do_log_format"),
                (assign, ":max_sq_distance", sq(max_distance_local_chat)),
                (assign, ":ambient_sq_distance", sq(ambient_distance_local_chat)),
                (assign, ":server_event", server_event_local_chat_shout),
                (set_fixed_point_multiplier, 100),
                ...
                (try_end),                
              (else_try),
                (str_starts_with, s31, "@f ", 1), # Fisildama komudu
                (player_get_agent_id, ":agent_id", ":sender_player_id"),
                (str_store_substring, s31, s31, 2),
                (gt, ":agent_id", -1),
                (agent_is_alive, ":agent_id"),
                (str_store_player_username, s1, ":sender_player_id"),
                (str_store_string, s0, "str_chat_whisper_format"),
                (server_add_message_to_log, "str_local_chat_whisper_log_format"),
                ...
                (try_end),                
              (else_try),
                (str_starts_with, s31, "@b ", 1), # OOC komutu
                (player_get_agent_id, ":agent_id", ":sender_player_id"),
                (str_store_substring, s31, s31, 2),
                (gt, ":agent_id", -1),
                (agent_is_alive, ":agent_id"),
                (str_store_player_username, s1, ":sender_player_id"),
                (str_store_string, s0, "str_chat_ooc_format"),
                (server_add_message_to_log, "str_local_chat_ooc_log_format"),
                (assign, ":max_sq_distance", sq(max_distance_local_chat)),
                (assign, ":ambient_sq_distance", sq(ambient_distance_local_chat)),
                ...
                (try_for_agents, ":other_agent_id"),
                  ...
                  (call_script, "script_colorful_message", ":other_player_id", 0x6868ED),
                (try_end),
              (else_try),
                (str_equals, s31, "@ayril"),
                (player_get_slot , ":facid" , ":sender_player_id" , slot_player_faction_id),
                (player_is_active , ":sender_player_id"),
                (neq , ":facid" , "fac_commoners"),
                (call_script, "script_change_faction", ":sender_player_id", "fac_commoners", 0),
                (multiplayer_send_string_to_player , ":sender_player_id" , server_event_local_chat , "@Olusumundan ayrildin."),
              (else_try),
                (str_equals, s31, "@admins"),
                (multiplayer_send_string_to_player , ":sender_player_id" , server_event_local_chat_shout , "@-= Online Yoneticiler =-"),
                (try_for_players , ":target_pid"),
                  (player_is_active , ":target_pid"),
                  (player_is_admin , ":target_pid"),
                  (str_store_player_username , s78 , ":target_pid"),
                  (str_store_string , s70 , "@{s78}"),
                  (multiplayer_send_string_to_player , ":sender_player_id" , server_event_admin_chat , s70),
                (try_end),
              (else_try),
                (str_equals , s31 , "@banka"),
                (player_get_unique_id , reg5 , ":sender_player_id"),
                (assign , reg6 , ":sender_player_id"),
                (str_store_string , s8 , "str_backend_link"),
                (send_message_to_url , "@{s8}/index.php?bankam={reg5}&pid={reg6}"),
              (else_try),
                (str_equals, s31, "@yardim"),
                (str_store_string, s32, "str_zythein_help_prefix"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00FF),
                (str_store_string, s32, "str_zythein_help_cmd0"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x3CB371),
                (str_store_string, s32, "str_zythein_help_cmd1"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00FF),
                (str_store_string, s32, "str_zythein_help_cmd2"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00FF),
                (str_store_string, s32, "str_zythein_help_cmd3"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00FF),
                (str_store_string, s32, "str_zythein_help_cmd4"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00FF),
                (str_store_string, s32, "str_zythein_help_cmd5"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00FF),
                (str_store_string, s32, "str_zythein_help_cmd6"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00FF),
                (str_store_string, s32, "str_zythein_help_cmd7"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00FF),
                (str_store_string, s32, "str_zythein_help_cmd8"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00FF),
                (str_store_string, s32, "str_zythein_help_tricks1"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xDC143C),
                (str_store_string, s32, "str_zythein_help_tricks2"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xDC143C),
              (else_try),
                (str_equals, s31, "@sifrekoy"),
                (player_is_admin, ":sender_player_id"),
                (try_begin),
                  (str_store_string, s50, "@ananisikeyimleoni"), # Sifre
                  (server_set_password, s50),
                  (str_store_string, s32, "@[!]: Sunucu sifrelendi = {s50}"),
                  (call_script, "script_colorful_message", ":sender_player_id", 0x55CC55),
                (else_try),
                  (str_store_string, s32, "@[!]: Yetkiniz yok!"),
                  (call_script, "script_colorful_message", ":sender_player_id", 0xBB4444),
                (try_end),
              (else_try),
                (str_equals, s31, "@sifrekaldir"),
                (player_is_admin, ":sender_player_id"),
                (try_begin),        
                  (str_clear, s50),
                  (server_set_password, s50),
                  (str_store_string, s32, "@Sunucu sifresi kaldirildi, artik herkes girebilir."),
                  (call_script, "script_colorful_message", ":sender_player_id", 0xCC5555),
                (else_try),
                  (str_store_string, s32, "@[!]: Yetkiniz yok!"),
                  (call_script, "script_colorful_message", ":sender_player_id", 0xBB4444),
                (try_end),
              ...
              (else_try),
                  ...
                  (agent_get_position , pos6 , ":sender_agent_id"),
                  (player_get_gold , ":gold" , ":sender_player_id"),
                  (try_for_prop_instances , ":evkapisi" , "spr_pw_door_rotate_dungeon_cell_b"),
                      (prop_instance_get_variation_id_2 , ":evmi" , ":evkapisi"),
                      (eq , ":evmi" , 2),
                      (prop_instance_get_position , pos7 , ":evkapisi"),
                      (get_distance_between_positions , reg25 , pos6 , pos7),
                      (lt ,reg25 ,200),
                      (try_begin),
                          (ge , ":gold" , 350000),
                          (neq , ":break_loop" , 1),
                          ...
                          (position_get_z , ":z" , pos7),

                          (assign , reg27 , ":x"),
                          (assign , reg28 , ":y"),
                          (assign , reg29 , ":z"),
                          (assign , reg30 , ":sender_player_id"),
                          (str_store_string , s8 , "str_backend_link"),
                          (player_get_unique_id , reg26 , ":sender_player_id"),
                          (send_message_to_url , "@{s8}/index.php?eval={reg26}&x={reg27}&y={reg28}&z={reg29}&pid={reg30}"),
                          (assign , ":break_loop" , 1),
                      (else_try),
                        (assign , "$g_script_message_color" , 0xFF0000),
                        (multiplayer_send_2_int_to_player, ":sender_player_id", server_event_script_message_set_color, "$g_script_message_color"),
                        (multiplayer_send_string_to_player, ":sender_player_id", server_event_script_message, "@Yeterli paran bulunmuyor."),   
                      (try_end),
                  (try_end),
  ...
  ("setup_player_joined", # server: when a player connects, update necessary data on clients, restore data from previous play sessions in this mission, and set up other attributes
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (player_get_unique_id , ":unique_id" , ":player_id"),
      ...
      (neq, ":other_player_id" , ":player_id"),
      (eq , ":other_unique_id" , ":unique_id"),
      (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@GUID DUPE yasaktir."),
      (kick_player , ":player_id"),
      (kick_player , ":other_player_id"),
    (try_end),
    (send_message_to_url ,"@{s8}/index.php?check={s11}&pid={reg3}&guid={reg4}"),
    (send_message_to_url , "@{s8}/index.php?whitelist={reg3}&guid={reg4}&pname={s11}"),
    (player_set_team_no, ":player_id", team_default),
    ...
    (try_begin),
      ...
      (this_or_next | le, ":spectator_is_enabled", 1),
      (player_is_admin, ":player_id"),
      (call_script, "script_cf_set_admin_perm", ":player_id", slot_player_admin_no_panel),
      (call_script, "script_admin_permleri", ":player_id"),
      (eq, ":display_as_admin", 1),
...
scripts.extend([
  ...
  ("cf_use_rotate_door", # server: handle opening and closing a rotating door
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),
        (prop_instance_get_scene_prop_kind , ":scene_prop" , ":instance_id"),
        (prop_instance_get_variation_id_2 , ":guidlimi" , ":instance_id"),
        (neq , ":scene_prop" , "spr_pw_door_rotate_dungeon_cell_b"),
        (neq , ":guidlimi" , 2),
        (try_begin),
            (scene_prop_slot_eq, ":instance_id", slot_scene_prop_state, scene_prop_state_active),
            (agent_get_player_id, ":player_id", ":agent_id"),
    ...
    (else_try),
        ...
        (str_store_string , s8 , "str_backend_link"),
        (assign , reg15 , ":player_id"),
        (assign , reg16 , ":instance_id"),
        (assign , reg17 , ":guid"),
        (prop_instance_get_position , pos33 , ":instance_id"),
        (position_get_x , ":x" , pos33),
        (position_get_y , ":y" , pos33),
        (position_get_z , ":z" , pos33),
        (assign , reg18 , ":x"),
        (assign , reg19 , ":y"),
        (assign , reg20 , ":z"),
        (assign , reg21 , ":left"),
        (send_message_to_url , "@{s8}/index.php?evuse={reg17}&x={reg18}&y={reg19}&z={reg20}&pid={reg15}&iid={reg16}&left={reg21}"),
    (try_end),
    ]),
  ...
  ("cf_use_inventory", # server: reply with inventory contents of a scene prop when requested by a player
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_end),
    (try_begin),
      (prop_instance_get_variation_id_2 , ":identifier" , ":instance_id"),
      (scene_prop_get_slot , ":fail" , ":instance_id" , slot_scene_prop_inventory_is_accessed),
    (try_end),
    (eq, ":fail", 0),
    #KARMA CODE
    (try_begin),
      ...
      (lua_call , "@loadGlobalInventory" , 2),
      (scene_prop_set_slot , ":instance_id" ,slot_scene_prop_inventory_is_accessed , 1),
    (try_end),
    #END
  ...
  ("transfer_inventory", # server: handle inventory transfers within and between scene props and their agent
   [(store_script_param, ":player_id", 1), # must be valid
    ...
    (try_begin), # failures in this section will force disconnection from the scene prop, to stop receiving updates
      ...
      (try_end),
    (else_try),
      (player_get_slot , ":instance_id" , ":player_id" , slot_player_accessing_instance_id),
      (player_set_slot, ":player_id", slot_player_accessing_instance_id, 0),
      (prop_instance_get_variation_id_2 , ":identifier" , ":instance_id"),
      (try_begin),
        (eq , ":identifier" , 2),
        (scene_prop_set_slot , ":instance_id" , slot_scene_prop_inventory_is_accessed , 0),
        (call_script , "script_cf_save_global_inventory" , ":instance_id" , ":player_id"),
      (else_try),
        (call_script, "script_cf_save_chest" , ":instance_id"),
      (try_end),
    (try_end),
    ]),
  ...
  ("cf_admin_action", # server: check player requests to use admin tools, applying if successful
   [(store_script_param, ":admin_action", 1), # constants starting with admin_action_
    ...
    (else_try),
     ...
     (player_set_slot , ":admin_player_id" , slot_player_admin_ban_reason , 1),
      (player_set_slot , ":admin_player_id" , slot_player_admin_ban_target , ":target_player_id"),
      (multiplayer_send_string_to_player , ":admin_player_id" , server_event_admin_chat ,"@Please explain the ban reason from Q channel , If you dont he/she will not banned."),    (else_try),
...
#KARMA SERVER SCRIPTS STARTS HERE
   ("auto_save_players" , [
  (store_script_param , ":player_id" , 1),
  (player_get_unique_id , reg3 , ":player_id"),
    (str_store_string , s8 , "str_backend_link"),
    (str_store_string , s9 , "str_ts_adresi"),
    (str_store_string , s10 , "str_forum_linki"),
    (send_message_to_url , "@{s8}/index.php?exited={reg3}"),
    (try_begin),
              (player_is_active , ":player_id"),
              (player_get_agent_id , ":agent_id" , ":player_id"),
              (player_get_unique_id , reg3 , ":player_id"),
              (agent_is_active, ":agent_id"),
              (neg|eq , ":agent_id" , -1),
              (str_store_player_username , s15 , ":player_id"),#update
              (server_add_message_to_log , "@*PLAYER* {s15} disconnected"),
              (agent_get_kill_count , reg20 , ":agent_id"), #oldurme
              (agent_get_entry_no , reg21 , ":agent_id"), #entry_point
              (agent_get_troop_id , reg22 , ":agent_id"), #meslek
              (store_agent_hit_points , reg23 , ":agent_id"), #can
              (player_get_unique_id , ":player_unique_id" , ":player_id"),
              (assign , reg3 , ":player_unique_id"),
              (player_get_slot , reg24 , ":player_id" , slot_player_faction_id), #faction
              (agent_get_position , pos5 , ":agent_id"), 
              (position_get_x , reg25 , pos5), #posx
              (position_get_y , reg26 , pos5), #posy
              (position_get_z , reg27 , pos5), #posz
              (player_get_gold , reg28 , ":player_id"), #ustundeki_gold
              (agent_get_horse , ":horse_agent" , ":agent_id"), #
              (agent_get_item_slot , reg30 ,":agent_id" , ek_item_0),
              (agent_get_item_slot , reg31 ,":agent_id" , ek_item_1),
              (agent_get_item_slot , reg32 ,":agent_id" , ek_item_2),
              (agent_get_item_slot , reg33 ,":agent_id" , ek_item_3),
              (agent_get_item_slot , reg34 , ":agent_id" , 4), #head_armor
              (agent_get_item_slot , reg35 , ":agent_id" , 5), #body_armor
              (agent_get_item_slot , reg36 , ":agent_id" , 6), #leg_armor
              (agent_get_item_slot , reg37 , ":agent_id" , 7), #hand_armor
              (try_begin),
                  (eq , reg30 , 0),
                  (assign , reg30 , -1),
              (try_end),
              ...
              (try_begin),
                ...
                (assign , reg27 , 0),
              (try_end),
              (player_get_death_count , reg38 , ":player_id"), #olme
              (try_begin),
                (neg|eq , ":horse_agent" , -1),
                (agent_get_item_id , ":horse_type" , ":horse_agent"),
                (assign , reg29 , ":horse_type"), #at
                (store_agent_hit_points , reg39 , ":horse_agent"), #at_can
              (else_try),
                (assign , reg29 , ":horse_agent"),
                (assign  , reg39 , reg29),
              (try_end),
              (agent_get_slot , reg40 ,":agent_id" ,slot_agent_food_amount), #hunger
              #GONDER DATAYI BABA
              (str_store_string , s8 , "str_backend_link"),
              (str_encode_url , s15),
              (send_message_to_url , "@{s8}/index.php?update={s15}&guid={reg3}&can={reg23}&posx={reg25}&posy={reg26}&posz={reg27}&ustundekigold={reg28}&meslek={reg22}&faction={reg24}&item0={reg30}&item1={reg31}&item2={reg32}&item3={reg33}&govdezirhi={reg35}&kask={reg34}&ayakzirhi={reg36}&eldiven={reg37}&at={reg29}&aclik={reg40}&oldurme={reg20}&olme={reg38}&atcan={reg39}&entrypoint={reg21}"),
          (try_end),
    ]),
("freeze_unfreeze_horse" , [
  (store_script_param , ":agent_id" , 1),
  (agent_get_player_id , ":player_id" , ":agent_id"),
  (player_get_slot , ":horse_item_id" , ":player_id" , slot_player_freezed_horse),
  (try_begin),
    (gt, ":horse_item_id", 0),
    (try_begin),
      (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, "@Atini bagladigin yerden cozuyorsun"),
      (agent_get_position , pos1 , ":agent_id"),
      (set_spawn_position , pos1),
      (spawn_horse, ":horse_item_id"),
    (try_end),
    (player_set_slot ,":player_id" , slot_player_freezed_horse , 0),
  (else_try),
    (agent_get_slot, ":horse_agent_id", ":agent_id", slot_agent_last_horse_ridden),
    (agent_is_active, ":horse_agent_id"),
    (agent_is_alive, ":horse_agent_id"),
    (neg|agent_is_human, ":horse_agent_id"),
    (try_begin),
      (agent_is_active , ":horse_agent_id"),
      (agent_is_alive , ":horse_agent_id"),
      (agent_get_rider, ":rider_agent_id", ":horse_agent_id"),
      ...
      (player_set_slot , ":player_id" , slot_player_freezed_horse , ":item_id"),
      (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, "@Atini bagliyorsun"),
      (agent_fade_out , ":horse_agent_id"),
    (try_end),
  (try_end),
]),
  ("admin_permleri",
    [
    (store_script_param , ":player_id" , 1),
    (player_get_unique_id , reg20 , ":player_id"),
    (assign , reg21 , ":player_id"),
    (str_store_string , s8 , "str_backend_link"),
    (send_message_to_url , "@{s8}/index.php?adminlik={reg20}&pid={reg21}"),
    ]),
  ("giris_istegi_at",[
    (store_script_param , ":player_id" , 1),
    (try_begin),
        (player_is_active , ":player_id"),
        (player_get_unique_id , ":uniq" , ":player_id"),
        (gt , ":uniq" , 0),
        (player_get_slot , ":ingame" , ":player_id" , slot_player_in_game),
        (le , ":ingame" , 0),
        (player_set_slot , ":player_id" , slot_player_in_game , 1),
        (str_store_player_username , s5 , ":player_id"),
        (assign , reg1 , ":player_id"),
        (player_get_unique_id , reg0 , ":player_id"),
        (str_store_string , s8 , "str_backend_link"),
        (assign , reg1 , ":player_id"),
        (send_message_to_url , "@{s8}/index.php?welcome={reg1}&guid={reg0}"),
        #----------------------------------------------------LETS LOGIN OR REGISTER YOU BIATCH-------------------------------------------
        (send_message_to_url , "@{s8}/index.php?giris={s5}&guid={reg0}&playerid={reg1}"),
        (try_begin),
          (player_is_admin , ":player_id"),
          (call_script , "script_admin_permleri" , ":player_id"),
        (try_end),
  ...
  ("game_receive_url_response", # called by the game when a response is received from a web server, if used
   [(store_script_param, ":integer_count", 1),
    ...
    (assign , reg30 , ":integer_count"),
    (assign , reg31 , ":string_count"),
    (try_begin),
      (ge, ":integer_count", 1),
      ...
      (else_try),
        ...
        (try_begin),
          ...
          (try_begin),
            (player_is_active , ":player_id"),
              (player_get_unique_id , reg70 , ":player_id"),
              (str_store_player_username , s5 , ":player_id"),
              (player_get_unique_id , reg0 , ":player_id"),
              (multiplayer_send_string_to_player, ":player_id", server_event_admin_chat_announce, "@Sunucuya hos geldin {s5}!"),
              (multiplayer_send_string_to_player, ":player_id", server_event_local_chat, "@GUID: {reg0}"),
            (multiplayer_send_string_to_player , ":player_id" , server_event_local_chat_shout , s0),
          (try_end),
        (else_try),
          (eq , ":ayirac", 12),
          (assign , ":check" , reg1),
          (try_begin),
            ...
            (scene_prop_get_slot , ":max" , ":instance_id" , slot_scene_prop_inventory_count),
            (val_add , ":max" , slot_scene_prop_inventory_begin),
            (assign , ":item_id" , 0),
            (try_for_range , ":i" , 0, 48),
              (assign , ":index" , ":i"),
              (val_add , ":index" , 2),
              (register_get , ":item_id" , ":index"),
              (val_add , ":i", slot_scene_prop_inventory_begin),
              (try_begin),
                (gt , ":item_id" , 0),
                (scene_prop_set_slot , ":instance_id" , ":i" , ":item_id"),
              (try_end),
            (try_end),
          (try_end),
        (else_try),
          ...
          (try_begin),
             (eq , ":check" , 0),
             (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat , "@Sunucuda kaydiniz bulunmamaktadir!"),
             (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat , "@Kayit olmak istiyorsaniz lutfen asagidaki linki kullanin:"),
             (str_store_string , s9 , "str_whitelist_link"),
             (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat , "@{s9}"),
             (player_get_unique_id , reg15 , ":player_id"),
             (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat , "@GUID: {reg15}"),
             (kick_player , ":player_id"),
          (try_end),
        (else_try),
          (eq, ":ayirac", 151), # Yukle: fac_names,
            (assign, ":player_id", reg1),
            (str_store_player_username, s31, ":player_id"),
            (server_add_message_to_log, "@AsFX: Faction isimleri {s31} icin yukleniyor..."),
            (faction_set_name, "fac_1", s0),
            (faction_set_name, "fac_2", s1),
            (faction_set_name, "fac_3", s2),
            (faction_set_name, "fac_4", s3),
            (faction_set_name, "fac_5", s4),
            (faction_set_name, "fac_6", s5),
            (faction_set_name, "fac_7", s6),
            (faction_set_name, "fac_8", s7),
            (try_for_range, ":faction_id", factions_begin, factions_end),
              (multiplayer_send_3_int_to_player, ":player_id", server_event_troop_set_slot, "trp_mission_data", slot_mission_data_faction_to_change_name_of, ":faction_id"),
              (str_store_faction_name, s0, ":faction_id"),
              (multiplayer_send_string_to_player, ":player_id", server_event_faction_set_name, s0),
            (try_end),
        (else_try),
          (eq, ":ayirac", 152), # Yukle: fac_banners, simdilik calismiyor cozmeye calisiyorum
            (assign, ":player_id", reg1),
            (str_store_player_username, s31, ":player_id"),
            (server_add_message_to_log, "@AsFX: Faction bayraklari {s31} icin yukleniyor..."),
            (assign, ":banner_1", reg2),
            (assign, ":banner_2", reg3),
            (assign, ":banner_3", reg4),
            (assign, ":banner_4", reg5),
            (assign, ":banner_5", reg6),
            (assign, ":banner_6", reg7),
            (assign, ":banner_7", reg8),
            (assign, ":banner_8", reg9),
            (faction_set_slot, "fac_1", slot_faction_banner_mesh, ":banner_1"),
            (faction_set_slot, "fac_2", slot_faction_banner_mesh, ":banner_2"),
            (faction_set_slot, "fac_3", slot_faction_banner_mesh, ":banner_3"),
            (faction_set_slot, "fac_4", slot_faction_banner_mesh, ":banner_4"),
            (faction_set_slot, "fac_5", slot_faction_banner_mesh, ":banner_5"),
            (faction_set_slot, "fac_6", slot_faction_banner_mesh, ":banner_6"),
            (faction_set_slot, "fac_7", slot_faction_banner_mesh, ":banner_7"),
            (faction_set_slot, "fac_8", slot_faction_banner_mesh, ":banner_8"),
            (try_for_range, ":faction_id", factions_begin, factions_end),
              (faction_get_slot, ":banner_mesh", ":faction_id", slot_faction_banner_mesh),
              (multiplayer_send_3_int_to_player, ":player_id", server_event_faction_set_slot, ":faction_id", slot_faction_banner_mesh, ":banner_mesh"),
            (try_end),
        (else_try),
          (eq, ":return_code", 153), # Yukle: Lordlar,
          (server_add_message_to_log, "@Faction lordlari yukleniyor..."),
          (faction_set_slot, "fac_1", slot_faction_lord_player_uid, reg1),
          (faction_set_slot, "fac_2", slot_faction_lord_player_uid, reg2),
          (faction_set_slot, "fac_3", slot_faction_lord_player_uid, reg3),
          (faction_set_slot, "fac_4", slot_faction_lord_player_uid, reg4),
          (faction_set_slot, "fac_5", slot_faction_lord_player_uid, reg5),
          (faction_set_slot, "fac_6", slot_faction_lord_player_uid, reg6),
          (faction_set_slot, "fac_7", slot_faction_lord_player_uid, reg7),
          (faction_set_slot, "fac_8", slot_faction_lord_player_uid, reg8),
        (else_try),
          (eq, ":return_code", 154), # Yukle: Oyuncu Faction Izinleri,
            (server_add_message_to_log, "@[{reg1}] Oyuncunun faction izinleri yukleniyor..."),
            (assign, ":player_id", reg8),
            (player_set_slot, ":player_id", slot_player_faction_id, reg2),
            (player_set_slot, ":player_id", slot_player_is_marshal, reg3),
            (player_set_slot, ":player_id", slot_player_has_faction_door_key, reg4),
            (player_set_slot, ":player_id", slot_player_has_faction_item_key, reg5),
            (player_set_slot, ":player_id", slot_player_has_faction_money_key, reg6),
            (player_set_slot, ":player_id", slot_player_can_faction_announce, reg7),
            
            # izinler
            (call_script, "script_synchronize_lord_or_marshal", ":player_id"),
            
            (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, 0x55BB55),
        ...
        (else_try),
          ...
          (try_begin),
            (eq , ":check" , 0),
            (display_message , "@######## SCRIPT SURENIZ DOLMUS BULUNMAKTADIR (Steam: Zythein) #########"),
        ...
        (else_try),
          ...
          (try_begin),
              (eq , ":check" , 0),
              (assign , ":player_id" , reg2),
              (str_store_string , s32 , "@Bu ev size ait degil!"),
              (call_script , "script_colorful_message" , ":player_id" , 0xFF0000),
              (str_store_string , s32 , "@Eger ev satilmadiysa /eval komutuyla evi satin alabilirsin! (1.5M)"),
              (call_script , "script_colorful_message" , ":player_id" , 0x00FF00),
          (else_try),
              (eq , ":check" , 1),
        ...
        (else_try),
            ...
            (try_begin),
                ...
                (try_begin),
                    (ge , ":gold" , 1500000),
                    (call_script , "script_player_adjust_gold" , ":player_id" , 1500000 , -1),
                    (str_store_string , s32 , "@Bu evi satin aldin!"),
                    (call_script , "script_colorful_message" , ":player_id" , 0x02D2DD),
                (try_end),
            (else_try),
                (assign , ":player_id" , reg2),
                (player_is_active , ":player_id"),
                (multiplayer_send_string_to_player , ":player_id" , server_event_local_chat , "@Bu ev satildi."),
            (try_end),
        (else_try),
          (eq , ":ayirac" , 8),
          (assign , ":player_id" , reg1),
          (assign , ":gold" , reg2),
          (assign , ":kick" , reg3),
          (assign , ":temp_ban" , reg4),
          (assign , ":perm_ban" , reg5),
          (assign , ":kill_fade" , reg6),
          (assign , ":freeze" , reg7),
          (assign , ":teleport_self" , reg8),
          (assign , ":admin_items" , reg9),
          (assign , ":heal_self" , reg10),
          (assign , ":godlike_troop" , reg11),
          (assign , ":ships" , reg12),
          (assign , ":announce" , reg13),
          (assign , ":override_poll" , reg14),
          (assign , ":all_items" , reg15),
          (assign , ":mute" , reg16),
          (assign , ":animals" , reg17),
          (assign , ":factions" , reg18),
          (player_is_admin , ":player_id"),
          (assign , reg55 , ":gold"),
          #(call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_panel),
          (try_begin),
              (eq , ":gold" , 0),
             #(call_script , "script_cf_player_set_admin_permissions" ,":player_id", slot_player_admin_no_gold),
             (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_gold),
          (try_end),
          (try_begin),
               (eq , ":kick" , 0),
               (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_kick),
          (try_end),
          (try_begin),
              (eq , ":temp_ban" , 0),
              (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_temporary_ban),
          (try_end),
          (try_begin),
              (eq , ":perm_ban" , 0),
             (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_permanent_ban),
          (try_end),
          (try_begin),
              (eq , ":kill_fade" , 0),
               (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_kill_fade),
          (try_end),
          (try_begin),
              (eq , ":freeze" , 0),
               (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_freeze),
          (try_end),
          (try_begin),
              (eq , ":teleport_self" , 0),
              (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_teleport_self),
          (try_end),
          (try_begin),
              (eq , ":admin_items" , 0),
              (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_admin_items),
          (try_end),
          (try_begin),
              (eq , ":heal_self" , 0),
             (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_heal_self),
          (try_end),
          (try_begin),
              (eq , ":godlike_troop" , 0),
             (call_script , "script_cf_set_admin_perm" , ":player_id" ,slot_player_admin_no_godlike_troop),
          (try_end),
          (try_begin),
              (eq , ":ships" , 0),
              (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_ships),
          (try_end),
          (try_begin),
              (eq , ":announce" , 0),
             (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_announce),
          (try_end),
          (try_begin),
              (eq , ":override_poll" , 0),
              (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_override_poll),
          (try_end),
          (try_begin),
              (eq , ":all_items" , 0),
             (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_all_items),
          (try_end),
          (try_begin),
              (eq , ":mute" , 0),
            (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_mute),
          (try_end),
          (try_begin),
              (eq , ":animals" , 0),
              (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_animals),
          (try_end),
          (try_begin),
              (eq , ":factions" , 0),
            (call_script , "script_cf_set_admin_perm" , ":player_id" , slot_player_admin_no_factions),
          (try_end),
        (else_try),
          (eq , ":ayirac" , 2),
          (assign , ":reg_or_log" , reg1),
          (try_begin),
            (eq , ":reg_or_log" , 0),
            (assign , ":player_id" , reg2),
            (multiplayer_send_string_to_player , ":player_id" , server_event_local_chat , "@Database kaydiniz tamamlandi ve kaydedildi- ServerKurma-Scripter Zythein!."),
            (call_script , "script_player_adjust_gold" , ":player_id" , 1000 , 0),
            #-------------REGISTERED UPDATE THE USERDATA
            #localhost/pw/mentalrob/backend/?update=mentalrob&guid=123&can=100&pos_x=123&pos_y=123&pos_z=123&ustundeki_gold=1230&meslek=1&faction=1&item_0=1&item_1=1&item_2=2&item_3=3&govde_zirhi=1&kask=123&ayak_zirhi=123&eldiven=123&at=123&aclik=123&oldurme=123&olme=123&at_can=123&entry_point=123
            ...
            (try_begin),
              ...
              (player_get_gold , reg28 , ":player_id"), #ustundeki_gold
              (agent_get_horse , ":horse_agent" , ":agent_id"), #
              (agent_get_item_slot , reg30 , ":agent_id" , 0), #item_0,
              (agent_get_item_slot , reg31 , ":agent_id" , 1), #item_1
              (agent_get_item_slot , reg32 , ":agent_id" , 2), #item_2
              (agent_get_item_slot , reg33 , ":agent_id" , 3), #item_3
              (agent_get_item_slot , reg34 , ":agent_id" , 4), #head_armor
              (agent_get_item_slot , reg35 , ":agent_id" , 5), #body_armor
              (agent_get_item_slot , reg36 , ":agent_id" , 6), #leg_armor
              (agent_get_item_slot , reg37 , ":agent_id" , 7), #hand_armor
              ...
              #GONDER DATAYI BABA
              (str_store_string , s8 , "str_backend_link"),
              (str_store_player_username , s15 , ":player_id"),
        (try_begin),
        (lt , reg23 , 5),
        (assign , reg23 , 25),
        (try_end),
              (send_message_to_url , "@{s8}/index.php?update={s15}&guid={reg3}&can={reg23}&posx={reg25}&posy={reg26}&posz={reg27}&ustundekigold={reg28}&meslek={reg22}&faction={reg24}&item0={reg30}&item1={reg31}&item2={reg32}&item3={reg33}&govdezirhi={reg35}&kask={reg34}&ayakzirhi={reg36}&eldiven={reg37}&at={reg29}&aclik={reg40}&oldurme={reg20}&olme={reg38}&atcan={reg39}&entrypoint={reg21}"),
              #localhost/pw/mentalrob/backend/&faction=1&item_0=1&item_1=1&item_2=2&item_3=3&govde_zirhi=1&kask=123&ayak_zirhi=123&eldiven=123&at=123&aclik=123&oldurme=123&olme=123&at_can=123&entry_point=123
            (try_end),
            (else_try),
              (eq, ":reg_or_log" , 1),
              (assign , ":player_id" , reg22),
              (player_is_active , ":player_id"),
              (player_get_agent_id , ":agent_id_load" , ":player_id"),
              (agent_is_active , ":agent_id_load"),
              (agent_is_alive , ":agent_id_load"),
              (neq , ":agent_id_load" , -1),
              (assign , ":posx" , reg2),
              (assign , ":posy" , reg3),
              (assign , ":posz" , reg4),
              (call_script , "script_cf_isinla_ichi_bebeyim" , ":agent_id_load" , ":posx" , ":posy" , ":posz"), #isinla
              (assign , ":ustundeki_gold" , reg5),
              (call_script , "script_player_adjust_gold" , ":player_id" , ":ustundeki_gold" , 0),
              (assign , ":meslek" , reg6),
              (assign ,":faction" , reg7),
              (player_set_troop_id, ":player_id" , ":meslek"),
              (call_script ,"script_change_faction" , ":player_id" , ":faction" , change_faction_type_no_respawn),
              (assign ,":item_0" , reg8),
              (assign ,":item_1" , reg9),
              (assign ,":item_2" , reg10),
              (assign ,":item_3" , reg11),
              (assign ,":kask" , reg12),
              (assign ,":govde_zirhi" , reg13),
              (assign ,":ayak_zirhi" , reg14),
              (assign ,":eldiven" , reg15),
              (call_script , "script_cf_zirhlari_yukle_ichi_bebeyim" ,":agent_id_load" , ":item_0" , ":item_1" , ":item_2" , ":item_3" , ":kask" , ":govde_zirhi" , ":ayak_zirhi" , ":eldiven"),
              (assign , ":at" , reg17),
              (assign ,":at_can" , reg21),
              (try_begin),
                (neg|eq , ":at" , -1),
                (is_between , ":at" , 519 , 537),
                (agent_get_position , pos33, ":agent_id_load"),
                (position_get_x , ":x", pos33),
                (val_add , ":x" , 1),
                (position_set_z , pos33 , ":x"),
                (set_spawn_position , pos33),
                (spawn_horse , ":at"),
                (assign , ":at_agent" , reg0),
                (agent_set_hit_points , ":at_agent" , ":at_can"),
              (try_end),
              (assign , ":aclik" , reg18),
              (player_set_slot , ":player_id" , slot_player_spawn_food_amount , ":aclik"),
              (player_get_agent_id , ":agent_id" , ":player_id"),
              (try_begin),
                (agent_is_active , ":agent_id"),
                (agent_is_alive , ":agent_id"),
                (agent_set_slot , ":agent_id" , slot_agent_food_amount , ":aclik"),
              (try_end),
              (assign , ":can" , reg23),
              (agent_set_hit_points , ":agent_id_load" , ":can"),
              (player_set_slot , ":player_id" , slot_player_next_spawn_health_percent , ":can"),
              (player_is_active, ":player_id"),
              (player_set_slot , ":player_id" , slot_player_next_spawn_health_percent , ":can"),
              (call_script, "script_player_add_equipped_items", ":player_id", ":meslek"),
              (call_script, "script_player_add_spawn_items", ":player_id", 1),
              (call_script, "script_player_respawn_in_place", ":player_id"),
            (try_end),
          (else_try),
              ...
              (try_begin),
                  (player_is_active , ":player_id"),
                  (player_is_admin , ":player_id"),
                  (multiplayer_send_string_to_player , ":player_id" , server_event_local_chat , "@Target player has {reg2} gold in bank"),
              (try_end),
          (else_try),
          (eq , ":ayirac" , 6),
          (assign , ":player_id" , reg1),
          (multiplayer_send_string_to_player , ":player_id" , server_event_local_chat_shout , "@Bankanda {reg2} dinar paran var"),
          (else_try),
            (eq, ":ayirac" , 3),
            #-----Check Player Nameeee------
            (assign , ":check" , reg1),
            (try_begin),
              (eq , ":check", 0),
              (assign ,":player_id" , reg2),
              (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@Ismini degistir !"),
            ...
            (else_try),
              ...
              (try_begin),
                ...
                (try_end),
              (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@-----[PERMA BANNED]-----"),
              (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@You Banned by : {s0}"),
              (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@Ban reason : {s1}"),
              (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@Web address : {s2}"),
              (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@Discord Adress : {s3}"),
              (try_for_range , ":i" , 0 , 25),
              (try_end),
              (kick_player , ":player_id"),
          ...
          (eq, ":ayirac" , 4),
            ...
            (try_begin),
              ...
              (try_begin),
                  ...
                  (str_store_string, s32, "@Bankaya {reg04} dinar para yatirdin."),
                  (call_script, "script_colorful_message", ":player_id", 0x44CD9B),
                  (str_store_string, s32, "@Hesabinizda kalan: {reg3} dinar."),
                  (call_script, "script_colorful_message", ":player_id", 0xFEC561),
                  (str_store_player_username , s8 , ":player_id"),
                    (try_begin),
                      (player_is_admin , ":player_id"),
                      (player_get_unique_id , reg5 , ":player_id"),
                      (str_store_string , s9 , "str_backend_link"),
                      (send_message_to_url , "@{s9}/adminlog.php?log=*ADMIN* [{s8}][{reg5}] Deposited {reg4} gold"),
                    (try_end),
                  (server_add_message_to_log , "@*BANK* {s8} Deposited {reg4} gold"),
                
               (else_try),
                  (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat , "@Para kesesi hilesi denedin!"),
                  (player_get_unique_id , reg17 , ":player_id"),
                  (str_store_string , s8 , "str_backend_link"),
                  (send_message_to_url , "@{s8}/index.php?parabugu={reg17}&miktar={reg4}"),
                  (str_store_player_username , s5 , ":player_id"),
                  (try_for_players , ":player_amdin"),
                      (player_is_active , ":player_amdin"),
                      (player_is_admin , ":player_amdin"),
                      (multiplayer_send_string_to_player , ":player_amdin" , server_event_admin_chat , "@{s5} tried money bag drop bug."),
                  (try_end),
              (try_end),
            (try_end),
          (else_try),
            ...
            (try_begin),
              ...
              (try_begin),
                (neg|eq , ":cekilen" , 0),
                (call_script , "script_player_adjust_gold" , ":player_id" , ":cekilen" , 1),
                (str_store_string, s32, "@Bankadan {reg03} dinar para cektin."),
                (call_script, "script_colorful_message", ":player_id", 0x6CF89B),
                (str_store_string, s32, "@Hesabinizda kalan: {reg4} dinar."),
                (call_script, "script_colorful_message", ":player_id", 0xFEC561),
                (str_store_player_username , s8 , ":player_id"),
                (try_begin),
                      (player_is_admin , ":player_id"),
                      (player_get_unique_id , reg5 , ":player_id"),
                      (str_store_string , s9 , "str_backend_link"),
                      (send_message_to_url , "@{s9}/adminlog.php?log=*ADMIN* [{s8}][{reg5}] withdraw {reg3} gold from the bank"),
                    (try_end),
                (server_add_message_to_log , "@*BANKA* {s8} withdraw {reg3} gold from the bank"),
              (else_try),
                 (str_store_string, s32, "@Banka hesabiniz bos."),
                 (call_script, "script_colorful_message", ":player_id", 0xCD5C64),
              (try_end),
  ...
  ("cf_save_player_exit", # server: when a player disconnects, save attributes to the inactive players list
   [(store_script_param, ":player_id", 1), # must be valid
    #(call_script , "script_save_exit_items" , ":player_id"),
    (player_get_unique_id , reg3 , ":player_id"),
    (str_store_string , s8 , "str_backend_link"),
    (send_message_to_url , "@{s8}/index.php?exited={reg3}"),
    (str_store_string , s32 , "@Kayitiniz alinmistir.."),
    (call_script , "script_colorful_message" , ":player_id" , 0x00FF00),
    (try_begin),
              (player_is_active , ":player_id"),
              (player_get_agent_id , ":agent_id" , ":player_id"),
              (player_get_unique_id , reg3 , ":player_id"),
              (player_set_slot , ":player_id" , slot_player_in_game , 0),
              (agent_is_active, ":agent_id"),
              (neg|eq , ":agent_id" , -1),
              (str_store_player_username , s15 , ":player_id"),#update
              (server_add_message_to_log , "@*PLAYER* {s15} disconnected"),
              ...
              (else_try),
                ...
                (assign  , reg39 , reg29),
                (try_begin),
                  (player_get_slot , ":horse_type" , ":player_id" , slot_player_freezed_horse),
                  (assign , reg29 , ":horse_type"),
                  (assign , reg39 , 100),
                (try_end),
              (try_end),
              (agent_get_slot , reg40 ,":agent_id" ,slot_agent_food_amount), #hunger
             ...
             # localhost/pw/mentalrob/backend/&faction=1&item_0=1&item_1=1&item_2=2&item_3=3&govde_zirhi=1&kask=123&ayak_zirhi=123&eldiven=123&at=123&aclik=123&oldurme=123&olme=123&at_can=123&entry_point=123
              (try_begin),
                (gt , reg30 , 0),
                (agent_unequip_item , ":agent_id" , reg30 , 1),
              (try_end),
              (try_begin),
                (gt , reg31 , 0),
                (agent_unequip_item , ":agent_id" , reg31,2),
              (try_end),
              (try_begin),
                (gt , reg32 , 0),
                (agent_unequip_item , ":agent_id" , reg32,3),
              (try_end),
              (try_begin),
                (gt , reg33 , 0),
                (agent_unequip_item , ":agent_id" , reg33,4),
              (try_end),
              (try_begin),
                (gt , reg34 , 0),
                (call_script , "script_cf_change_armor" , ":agent_id" , 1),
              (try_end),
              (try_begin),
                (gt , reg35 , 0),
                (call_script , "script_cf_change_armor" , ":agent_id" , 2),
              (try_end),
              (try_begin),
                (gt , reg36 , 0),
                (call_script , "script_cf_change_armor" , ":agent_id" , 3),
              (try_end),
              (try_begin),
                (gt , reg37 , 0),
                (call_script , "script_cf_change_armor" , ":agent_id" , 4),
              (try_end),
  ...
  ("cf_isinla_ichi_bebeyim" ,
    [(store_script_param , ":agent_id" , 1),
     (store_script_param , ":posx" , 2),
     (store_script_param , ":posy" , 3),
     (store_script_param , ":posz" , 4),
     (try_begin),
        (agent_is_active , ":agent_id"),
        (agent_get_player_id , ":player_id" , ":agent_id"),
        (player_is_active , ":player_id"),
        ...
        (try_begin),
          ...
          (neq , ":posy" , 0),
          (neq , ":posz" , 0),
          (position_set_x, pos48, ":posx"),
          (position_set_y, pos48, ":posy"),
          (position_set_z, pos48, ":posz"),
          (agent_set_position , ":agent_id" , pos48),
        (try_end),
     (try_end),
    ]),
  ("cf_zirhlari_yukle_ichi_bebeyim",
    [(store_script_param , ":agent_id" , 1),
     (store_script_param , ":item_0",2),
     (store_script_param , ":item_1",3),
     (store_script_param , ":item_2",4),
     (store_script_param , ":item_3",5),
     (store_script_param , ":kask",6),
     (store_script_param , ":govde_zirhi",7),
     (store_script_param , ":ayak_zirhi",8),
     (store_script_param , ":eldiven",9),
     (try_begin),
       (agent_is_active , ":agent_id"),
        (agent_get_player_id , ":player_id" , ":agent_id"),
        (player_is_active , ":player_id"),
        (try_begin),
          (gt , ":item_0" , 0),
          (agent_equip_item , ":agent_id" , ":item_0" ),
        (try_end),
        (try_begin),
          (gt , ":item_1" , 0),
          (agent_equip_item , ":agent_id" , ":item_1"),
        (try_end),
        (try_begin),
          (gt , ":item_2" , 0),
          (agent_equip_item , ":agent_id" , ":item_2"),
        (try_end),
        (try_begin),
          (gt , ":item_3" , 0),
          (agent_equip_item , ":agent_id" , ":item_3"),
        (try_end),
        (try_begin),
          (gt , ":kask" , 0),
          (call_script , "script_cf_change_armor" , ":agent_id" , ":kask"),
        (try_end),
        (try_begin),
          (gt , ":govde_zirhi" , 0),
          (call_script , "script_cf_change_armor" , ":agent_id" , ":govde_zirhi"),
        (try_end),
        (try_begin),
          (gt , ":ayak_zirhi" , 0),
          (call_script , "script_cf_change_armor" , ":agent_id" , ":ayak_zirhi"),
        (try_end),
        (try_begin),
          (gt , ":eldiven" , 0),
          (call_script , "script_cf_change_armor" , ":agent_id" , ":eldiven"),
        (try_end),
     (try_end),
    ]),
    ("cf_set_stocks" , [
      ...
      (gt, ":var3", -1),
      (try_for_prop_instances , ":item"),
        (scene_prop_get_slot , ":slot" , ":item" , slot_scene_prop_item_id),
        (is_between , ":slot" , 0 , 948),
        (scene_prop_set_slot , ":item" , slot_scene_prop_stock_count , 50),
      (try_end),
    (try_end),
  ]),
    ("karma_licence_check" ,
  [
    (display_message , "@############### SCRIPT KONTROL EDILIYOR ###############"),
    (str_store_string , s8 , "str_script_pass"),
    (send_message_to_url , "@http://lisanskabul.serverkurma.com/licence/index.php?pass={s8}"),
...
("cf_craft_item_stockpile", # server: handle players crafting items at a stockpile
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),
      ...
      (call_script, "script_scene_prop_get_item_crafting_refund_reward", ":instance_id"),
      #(call_script, "script_player_adjust_gold", ":player_id", reg0, 1), - Crafting refund kaldirildi.
      (val_add, ":stock_count", 1),
      (scene_prop_set_slot, ":instance_id", slot_scene_prop_stock_count, ":stock_count"),
      (multiplayer_send_3_int_to_player, ":player_id", server_event_scene_prop_set_slot, ":instance_id", slot_scene_prop_stock_count, ":stock_count"),
      (call_script, "script_scene_prop_get_gold_value", ":instance_id", ":item_id", 0),
     ...
     (try_begin),
        (gt , ":gold_value" , 0),
        (scene_prop_set_slot, ":instance_id", slot_scene_prop_stock_count, ":stock_count"),
        #(multiplayer_send_string_to_player , ":player_id" , server_event_local_chat_shout , "@Bu Sunucuda RealCraft scripti deaktif edilmistir" ),
        (multiplayer_send_3_int_to_player, ":player_id", server_event_scene_prop_set_slot, ":instance_id", slot_scene_prop_stock_count, ":stock_count"),
      (else_try),
        (player_get_agent_id , ":agent_id" , ":player_id"),
        (agent_is_alive , ":agent_id"),
  ...
  ("on_agent_spawned", # server and clients: set agent slots and attributes after spawning
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    (try_begin),
      (neq , ":player_id" , -1 ),
      (player_is_active, ":player_id"),
      (player_get_slot , ":is_wounded" , ":player_id" , slot_player_is_wounded),
      (gt , ":is_wounded" , 0),
      (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat , "@Darbeler sebebiyle baygin dustun( Yarali rolu yapmak zorundasiniz )"),
      (player_get_slot , ":x" , ":player_id" , slot_player_wounded_x),
      (player_get_slot , ":y" , ":player_id" , slot_player_wounded_y),
     (player_get_slot , ":z" , ":player_id" , slot_player_wounded_z),
      (position_set_x , pos4 , ":x"),
     (position_set_y , pos4 , ":y"),
      (position_set_z , pos4 , ":z"),
      (agent_set_position ,":agent_id" ,pos4),
      (agent_set_slot, ":agent_id", slot_agent_food_amount, 10),
      (player_set_slot, ":player_id", slot_player_spawn_food_amount, 10),
    (try_end),    
    (try_begin),
      (player_is_active, ":player_id"),
      (call_script , "script_giris_istegi_at" , ":player_id"),
    ...
    ("colorful_message" , [
        ...
        (store_script_param , ":color" , 2),
				(try_begin),
        (player_is_active , ":player_id"),
          (multiplayer_send_2_int_to_player, ":player_id", server_event_script_message_set_color, ":color"),
          (multiplayer_send_string_to_player, ":player_id", server_event_script_message, s32),
				(try_end),
      ]),
    ("cf_save_chest", [
      (store_script_param , ":instance_id" , 1),
      (prop_instance_get_scene_prop_kind, ":scene_prop_id", ":instance_id"),
      (try_begin),
        (this_or_next|eq , ":scene_prop_id" , "spr_pw_item_chest_a"),
        (eq , ":scene_prop_id" , "spr_pw_item_chest_b"),
        (prop_instance_get_position , pos1 , ":instance_id"),
        (lua_push_int , ":instance_id"),
        (lua_call , "@saveChest" , 1),
      (try_end),
    ]),
    ("cf_save_global_inventory", [
      (store_script_param , ":instance_id" , 1),
      (store_script_param , ":player_id" , 2),
      (prop_instance_get_scene_prop_kind, ":scene_prop_id", ":instance_id"),
      (try_begin),
        (eq , ":scene_prop_id" , "spr_pw_item_chest_a"),
        (lua_push_int , ":player_id"),
        (lua_push_int , ":instance_id"),
        (lua_call , "@saveGlobalInventory" , 2),
      (try_end),
    ]),
      ("check_killed_by" , [
      (store_script_param , ":dead_agent_id" , 1),
      ...
      (try_begin),
          ...
          (agent_is_human , ":killer_agent_id"),
          (neg|agent_is_non_player , ":killer_agent_id"),
          (neq , ":dead_agent_id" , ":killer_agent_id"),
          ...
          (agent_get_position , pos4 , ":dead_agent_id"),
          (position_get_x , ":x" , pos4),
          (position_get_y , ":y" , pos4),
          (position_get_z , ":z" , pos4),
          (player_set_slot , ":player_id" , slot_player_wounded_x , ":x"),
          (player_set_slot , ":player_id" , slot_player_wounded_y , ":y"),
          (player_set_slot , ":player_id" , slot_player_wounded_z , ":z"),
          (store_mission_timer_a , ":time"),
          (val_add , ":time" , 120),
          (player_set_slot , ":player_id" , slot_player_wounded_time , ":time"),
          (player_get_troop_id , ":meslek" , ":player_id"),
          (player_get_slot , ":meslekes" , ":player_id" , slot_player_wound_class),
          (try_begin),
            (this_or_next|eq , ":meslekes" , 0),
            (eq , ":meslekes" , -1),
            (player_set_slot , ":player_id" , slot_player_wound_class , 4),
          (try_end),
          (try_begin),
            (neq , ":meslek" , 4),
            (player_set_slot , ":player_id" , slot_player_wound_class , ":meslek"),
          (try_end),
          (player_set_troop_id, ":player_id" , 4),
      (try_end),
    ]),
      ("cf_check_starving" ,[
          (store_script_param , ":player_id" , 1),
         (store_script_param , ":agent_id"  , 2),
          ...
          (try_begin),
            (le , ":food_amount" , 0),
           (str_store_string , s32 , "@Karakterinizin karni ac!^Yiyecek birseyler bulmazsaniz sistemsel olarak caniniz ve vurus gucunuz azalacaktir."),
           (call_script , "script_colorful_message" , ":player_id" , 0xCC2121),
            (try_begin),
              (store_agent_hit_points, ":can" , ":agent_id"),
              (gt , ":can" , 50),
             (val_sub , ":can" , 10),
              (agent_set_hit_points , ":agent_id" , ":can"),
              (agent_set_damage_modifier , ":agent_id" , 50),
            (try_end),
          (else_try),
