...
"),
  ...
  ("admin_chat_format", "*YETKILI* [{s1}] {s0}"),
  ("admin_chat_player_format", "*OYUNCU* [{s1}] {s0}"),
  ("admin_chat_to_player_format", "*YETKILI* [{s1}] > [{s2}] {s0}"),
  ("admin_announcement_format", "*DUYURU* [{s1}] {s0}"),
  ("local_chat_log_format", "*CEVRE* {s0}"),
  ("faction_chat_log_format", "*KRALLIK* {s2} {s0}"),
...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("backend_link" , "http://127.0.0.1/scriptbackend"),
  ("script_pass" , "hamzatsiz4412"),
  ("ts_adresi" , "ts3.adresi.com"),
  ("forum_linki" , "www.forumlinki.com"),
  ("whitelist_link" , "www.whitelist.com"),
  ("chat_me_format", "* {s1} {s31}"),
  ("chat_do_format", "- {s31} ({s1})"),
  ("chat_whisper_format", "{s1} fisildar: {s31}"),
  ("chat_ooc_format", "[OOC] {s1}: {s31}"),
  ("local_chat_me_log_format", "[ME] {s31}"), # Ashcrow Me komutu
  ("local_chat_do_log_format", "[DO] {s31}"), # Ashcrow Do komutu
  ("local_chat_whisper_log_format", "[FISIL] {s31}"), # Ashcrow Whisper komutu
  ("local_chat_ooc_log_format", "[OOC] {s31}"), # Ashcrow OOC komutu
  ("zythein_help_prefix", "Bilmemne RPG - Komutlar ^ --------------------------"), # Ashcrow OOC komutu
  ("zythein_help_cmd0", "Scripts By Zythein -ServerKurma."),
  ("zythein_help_cmd1", "- /me: Hareket betimleme kanali."),
  ("zythein_help_cmd2", "- /do: Olay betimleme kanali."),
  ("zythein_help_cmd3", "- /f: Fisildama komutu."),
  ("zythein_help_cmd4", "- /b: Rol disi kanali."),
  ("zythein_help_cmd5", "- /admins: Aktif yoneticiler."),
  ("zythein_help_cmd6", "- /ayril: Olusumdan ayril."),
  ("zythein_help_cmd7", "- /banka: Bankanizdaki para."),
  ("zythein_help_cmd8", "- /eval: Ev satin al."),
  ("zythein_help_tricks1", "Sunucuda bu komutlari yerel sohbetten [Q] uygulamaniz gerekmektedir."),
  ("zythein_help_tricks2", "Yuksek sesle konusmak icin [Q] tusundan mesajinizi yazip, [R-SHIFT]+[ENTER] ile gonderin."),
  ("test_string" , "HELLO FUCKIN WORLD"), 
