...
scene_props = [
  ...
  ("pw_item_chest_invisible",sokf_invisible|spr_use_time(1),"pw_invisible_chest","bo_pw_invisible_chest",[
    (ti_on_scene_prop_init , []),
    (ti_on_scene_prop_cancel_use , [
      # Para cek
      (store_trigger_param_1, ":agent_id"),
      (store_trigger_param_2, ":scene_prop"),
      (prop_instance_get_variation_id_2, ":val2", ":scene_prop"),
      (try_begin),
        (eq, ":val2", 0),
        ...
        (player_get_unique_id , reg6 , ":player_id"),
        (assign , reg5 , ":player_id"),
        (send_message_to_url , "@{s8}/index.php?cek={reg6}&pid={reg5}&guid={reg6}"),
      (else_try),
        (eq, ":val2" , 1),
        (neg|agent_is_non_player , ":agent_id"),
        (agent_is_active , ":agent_id"),
        (call_script , "script_freeze_unfreeze_horse" , ":agent_id"),
      (try_end),
      ]),
    (ti_on_scene_prop_use , [
      # Para yatir
      ...
      (try_begin),
        ...
        (try_begin),
          ...
          (player_get_unique_id , reg6 , ":player_id"),
          (assign , reg7 , ":gold"),
          (send_message_to_url ,  "@{s8}/index.php?yatir={reg6}&pid={reg5}&guid={reg6}&amount={reg7}"),
        (try_end),
      (try_end),
      ]),
  ]),
