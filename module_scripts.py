          ...
          (try_begin),
            ...
            (try_begin),
              ...
              (else_try),
                ...
                (str_store_string, s32, "str_ash_help_prefix"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x6BB983),
                (str_store_string, s32, "str_ash_help_cmd1"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xEEE8C5),
                (str_store_string, s32, "str_ash_help_cmd2"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xEEE8C5),
                (str_store_string, s32, "str_ash_help_cmd3"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xEEE8C5),
                (str_store_string, s32, "str_ash_help_cmd4"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xEEE8C5),
                (str_store_string, s32, "str_ash_help_cmd5"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xEEE8C5),
                (str_store_string, s32, "str_ash_help_cmd6"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xEEE8C5),
                (str_store_string, s32, "str_ash_help_cmd7"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xEEE8C5),
                (str_store_string, s32, "str_ash_help_cmd8"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xEEE8C5),
                (str_store_string, s32, "str_ash_help_tricks1"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xD1DE09),
                (str_store_string, s32, "str_ash_help_tricks2"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xD1DE09),
              (else_try),
                (str_equals, s31, "@sifrekoy"),
                (player_is_admin, ":sender_player_id"),
                (try_begin),
                  (str_store_string, s50, "@12521"), # Sifre
...
("freeze_unfreeze_horse" , [
  ...
  [
    ...
    (send_message_to_url , "@http://mblisans.haliliceylan.com/licence/index.php?pass={s8}"),
