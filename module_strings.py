...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("ash_help_prefix", "Eightborn RPG - Komutlar ^ --------------------------"), # Ashcrow OOC komutu
  ("ash_help_cmd1", "- /me: Hareket betimleme kanali."),
  ("ash_help_cmd2", "- /do: Olay betimleme kanali."),
  ("ash_help_cmd3", "- /f: Fisildama komutu."),
  ("ash_help_cmd4", "- /b: Rol disi kanali."),
  ("ash_help_cmd5", "- /admins: Aktif yoneticiler."),
  ("ash_help_cmd6", "- /ayril: Olusumdan ayril."),
  ("ash_help_cmd7", "- /bank: Bankanizdaki para."),
  ("ash_help_cmd8", "- /eval: Ev satin al."),
  ("ash_help_tricks1", "Sunucuda bu komutlari yerel sohbetten [Q] uygulamaniz gerekmektedir."),
  ("ash_help_tricks2", "Yuksek sesle konusmak icin [Q] tusundan mesajinizi yazip, [R-SHIFT]+[ENTER] ile gonderin."),
