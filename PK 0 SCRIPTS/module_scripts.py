          ...
          (try_begin),
            ...
            (try_begin),
              ...
              (else_try),
                ...
                (str_store_string, s32, "str_flundar_help_prefix"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x6BB983),
                (str_store_string, s32, "str_flundar_help_cmd0"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xFF00AD),
                (str_store_string, s32, "str_flundar_help_cmd1"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x50f442),
                (str_store_string, s32, "str_flundar_help_cmd2"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x50f442),
                (str_store_string, s32, "str_flundar_help_cmd3"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x50f442),
                (str_store_string, s32, "str_flundar_help_cmd4"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x50f442),
                (str_store_string, s32, "str_flundar_help_cmd5"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x50f442),
                (str_store_string, s32, "str_flundar_help_cmd6"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x50f442),
                (str_store_string, s32, "str_flundar_help_cmd7"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x50f442),
                (str_store_string, s32, "str_flundar_help_cmd8"),
                (call_script, "script_colorful_message", ":sender_player_id", 0x50f442),
                (str_store_string, s32, "str_flundar_help_tricks1"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xe51f09),
                (str_store_string, s32, "str_flundar_help_tricks2"),
                (call_script, "script_colorful_message", ":sender_player_id", 0xe51f09),
              (else_try),
                (str_equals, s31, "@sifrekoy"),
                (player_is_admin, ":sender_player_id"),
                (try_begin),
                  (str_store_string, s50, "@4472"), # Sifre
  ...
  ("cf_admin_action", # server: check player requests to use admin tools, applying if successful
   [(store_script_param, ":admin_action", 1), # constants starting with admin_action_
    ...
    (else_try),
      ...
      (multiplayer_send_string_to_player , ":admin_player_id" , server_event_admin_chat ,"@Please explain the ban reason from Q channel , If you dont he/she will not banned."),
    (else_try),
...
("freeze_unfreeze_horse" , [
    ...
    (try_begin),
      ...
      (else_try),
        ...
        (else_try),
          ...
          (try_begin),
            (eq , ":check" , 0),
            (display_message , "@######## SCRIPT SURENIZ DOLMUS BULUNMAKTADIR (Steam: Mentalrob) #########"),
        ...
        (else_try),
            ...
            (else_try),
                (assign , ":player_id" , reg2),
                (player_is_active , ":player_id"),
                (multiplayer_send_string_to_player , ":player_id" , server_event_local_chat , "@This house sold."),
            (try_end),
        (else_try),
          (eq , ":ayirac" , 8),
          (assign , ":player_id" , reg1),
        ...
        (else_try),
          ...
          (try_begin),
            (eq , ":reg_or_log" , 0),
            (assign , ":player_id" , reg2),
            (multiplayer_send_string_to_player , ":player_id" , server_event_local_chat , "@Your registration is created on the server !."),
        ...
        (try_end),
          ...
          (else_try),
            ...
            (try_begin),
              (eq , ":check", 0),
              (assign ,":player_id" , reg2),
              (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@Please change your name !"),
            ...
            (else_try),
              ...
              (try_begin),
                ...
                (try_end),
              (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@-----[PERM BANNED]-----"),
              ...
              (multiplayer_send_string_to_player , ":player_id" , server_event_admin_chat_announce , "@TeamSpeak address : {s3}"),
              (kick_player , ":player_id"),
            (try_end),
          (else_try),
          (eq, ":ayirac" , 4),
  ...
  ("cf_zirhlari_yukle_ichi_bebeyim",
    ...
    ("karma_licence_check" ,
  [
    (display_message , "@############### SCRIPT KONTROL EDILIYOR (-Steam Zythein) ###############"),
    (str_store_string , s8 , "str_script_pass"),
    (send_message_to_url , "@http://localhost/licence/index.php?pass={s8}"),
