...
Poisonous herbs can also sometimes be found, which are then applied to the blades of certain weapons used for murderous deeds; they have many brown stalks covered in tiny green leaves."),
  ...
  ("flundar_help_prefix", "Eightborn RPG - Komutlar ^ --------------------------"), # Ashcrow OOC komutu
  ("flundar_help_cmd0", "Scripts By Zythein -ServerKurma."),
  ("flundar_help_cmd1", "- /me: Hareket betimleme kanali."),
  ("flundar_help_cmd2", "- /do: Olay betimleme kanali."),
  ("flundar_help_cmd3", "- /f: Fisildama komutu."),
  ("flundar_help_cmd4", "- /b: Rol disi kanali."),
  ("flundar_help_cmd5", "- /admins: Aktif yoneticiler."),
  ("flundar_help_cmd6", "- /ayril: Olusumdan ayril."),
  ("flundar_help_cmd7", "- /bank: Bankanizdaki para."),
  ("flundar_help_cmd8", "- /eval: Ev satin al."),
  ("flundar_help_tricks1", "Sunucuda bu komutlari yerel sohbetten [Q] uygulamaniz gerekmektedir."),
  ("flundar_help_tricks2", "Yuksek sesle konusmak icin [Q] tusundan mesajinizi yazip, [R-SHIFT]+[ENTER] ile gonderin."),
