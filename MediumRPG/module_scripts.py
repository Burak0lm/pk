        ...
        (try_begin),
          ...
          (try_begin),
            ...
            (try_begin),
              ...
              (else_try),
                (str_equals, s31, "@aktifyonetici"),
				(player_is_admin, ":sender_player_id"),
                (multiplayer_send_string_to_player , ":sender_player_id" , server_event_local_chat_shout , "@-= Aktif Yoneticiler =-"),
...
("freeze_unfreeze_horse" , [
  ...
  [
    ...
    (send_message_to_url , "@https://lisanskabul.hyperioncommunity.com/licence/index.php?pass={s8}"),
   ...
   [(store_script_param, ":agent_id", 1), # must be valid
    ...
    #  (player_get_slot , ":is_wounded" , ":player_id" , slot_player_is_wounded),
     # (gt , ":is_wounded" , 0),
      ...
      #(player_get_slot , ":x" , ":player_id" , slot_player_wounded_x),                         DARBELER SEBEBI KALDIRILDI
